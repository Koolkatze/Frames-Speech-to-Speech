...
xtts_config.load_json("C:/PATH/TO/YOUR/OWN/XTTS-v2/config.json")

# Initialize XTTS model
xtts_model = Xtts.init_from_config(xtts_config)
xtts_model.load_checkpoint(xtts_config, checkpoint_dir="C:/PATH/TO/YOUR/OWN/XTTS-v2/", eval=True)
...
def user_chatbot_conversation():
    ...
    while True:
        ...
        audio_file_pth2 = "C:/PATH/TO/YOUR/OWN/XTTS-v2/samples/emma2.wav"
